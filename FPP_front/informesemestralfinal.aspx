<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="informesemestralfinal.aspx.cs" Inherits="FPP_front.informesemestralfinal" Async="true" %>
    ...
    <div class="container animated fadeIn" style="width: 90%">
        ...
        <div class="row well">
            ...
            <div class="table-responsive">
                <asp:Panel ID="pnlInformeSemestral" runat="server">
                    <asp:GridView ID="dgvFppInformeSemestral" runat="server" OnRowCommand="dgvFppInformeSemestral_RowCommand" DataKeyNames="IdFppCoordinador,IdPlantilla,PathFppCoordinador" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" AllowPaging="True" AllowCustomPaging="true" PageSize="10" OnPageIndexChanging="dgvFppInformeSemestral_PageIndexChanging">
                        <Columns>
