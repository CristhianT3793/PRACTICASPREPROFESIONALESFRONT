<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fppPasantesCoordinador.aspx.cs" Inherits="FPP_front.fppPasantesCoordinador" Async="true" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                ...
                <!--primer tab-->
                <ajaxToolkit:TabPanel runat="server" HeaderText="Carga de FPP" ID="TabPanel1">
                    <ContentTemplate>
                        <!--Grid fpp-->
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <asp:Panel ID="pnlPasante" runat="server">
                                    <asp:GridView ID="dgvPasante" runat="server" DataKeyNames="IdFppPasante,IdPasante,IdEstadoFpp,IdPlantilla,FppPasantePath,FppPasanteObservacion,FppPasanteActivo,PathPlatilla,NomrePlantilla" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" AllowPaging="True" OnRowCommand="dgvPasante_RowCommand" OnRowDataBound="dgvPasante_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PathPlatilla" HeaderText="Plantilla FPP" SortExpression="PathPlatilla" />
                                            <asp:TemplateField HeaderText="Subir FPP">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="subirFpp" CommandName="subirFpp" runat="server" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>">
                                                    <i class="fas fa-file-upload" style="font-size:25px;color:green"></i>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Descargar Plantilla">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="dowloadPlantilla" CommandName="dowloadPlantilla" runat="server" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>">
                                        ...
                                        <%--<PagerStyle BackColor="#085394" ForeColor="#003399" HorizontalAlign="Left" />--%>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <asp:LinkButton ID="btnEnviarExpediente" CssClass="btn btn-sm btn-info" runat="server" OnClick="btnEnviarExpediente_Click">
                                Enviar Expediente 
                                </asp:LinkButton>
                            </div>
                            <div class="col-md-6">
                ...
                <!--segundo tab-->
                <ajaxToolkit:TabPanel runat="server" HeaderText="Datos Informativos" ID="TabPanel2">
                    <ContentTemplate>
                        <!--encabezado empresa-->
                        <div class="well">
                            <div class="row">
                ...
                <!--tab 4-->
                <ajaxToolkit:TabPanel runat="server" HeaderText="Prácticas del Estudiante" ID="TabPanel3">
                    <ContentTemplate>
        ...
        <asp:Panel ID="PanelModal3" runat="server" Style="display: none; background: white; width: 40%; height: auto; border-radius: 2px; box-shadow: 0 0 25px #5D5C5C;" CssClass="animated fadeIn">
            ...
            <div class="modal-body">
                <asp:Label ID="Label1" runat="server" Text="Archivo">
                </asp:Label>
                <asp:FileUpload ID="fileFpp" runat="server" CssClass="form-control" />
            </div>
            <div class="modal-footer">
                <asp:Button ID="btnSubirFpp" runat="server" Text="Subir" OnClick="btnSubirFpp_Click" CssClass="btn" />
