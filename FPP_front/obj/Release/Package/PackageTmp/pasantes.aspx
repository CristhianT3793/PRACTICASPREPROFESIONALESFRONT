<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="pasantes.aspx.cs" Inherits="FPP_front.pasantes" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container animated fadeIn" style="width: 90%">
        ...
        <div class="row well">
            <h4>Revisión Formularios de Pasantías
            </h4>
        </div>
                ...
                <asp:Panel ID="pnlPasante" runat="server">
                    <asp:GridView ID="dgvPasante" runat="server" DataKeyNames="IdPasante,IdentificacionPasante,NombrePasante,ApellidoPasante,NombreEmpresa,IdentificacionTutorEmpresa,CarreraPasante,FacultadPasante,IdCampoEspecifico,NumeroHorasPasante,FechaInicioPasante,FechaFinPasante,CarpetaPasanteExpediente,CodCarreraPasante,PeriodoPasante,EmailTutor,EstadoAprobado" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" AllowPaging="True" AllowCustomPaging="true" PageSize="10" OnRowCommand="dgvPasante_RowCommand" OnPageIndexChanging="dgvPasante_PageIndexChanging" OnRowDataBound="dgvPasante_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="CodCarreraPasante" HeaderText="Cod Carrera" SortExpression="CodCarreraPasante" Visible="false" />
